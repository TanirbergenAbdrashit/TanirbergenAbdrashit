...
| ------------------ | --------------------------------------- | ------------------ | ---------- |
| Customer Shopping Trends Dashboard | Дашборд предназначен для анализа покупательского поведения клиентов по продуктовым категориям, демографическим характеристикам, географии и сезонам. | Power BI | (https://github.com/TanirbergenAbdrashit/PowerBi_Portfolio-Customer_Shopping_Trends) |
